...
public class IRCompareEqInstruction extends IRInstruction {

    // Add instructions has two operands and produces a value
    public IRCompareEqInstruction(IRValue operand1, IRValue operand2) {
        super();
    ...
    public Object accept(IRVisitor v) {
        return v.visitCompareEqInstruction(this);
    }
