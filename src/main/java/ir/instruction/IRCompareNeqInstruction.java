...
public class IRCompareNeqInstruction extends IRInstruction {

    // Add instructions has two operands and produces a value
    public IRCompareNeqInstruction(IRValue operand1, IRValue operand2) {
        super();
    ...
    public Object accept(IRVisitor v) {
        return v.visitCompareNeqInstruction(this);
    }
